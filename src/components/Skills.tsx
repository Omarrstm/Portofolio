      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-2 flex items-center gap-3">
            <span className="text-indigo-600 dark:text-indigo-400 font-mono text-lg">02.</span>
            Skills
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {Object.entries(skills).map(([category, items], i) => (
              ...
              >
                <h3 className="text-sm font-semibold text-indigo-600 dark:text-indigo-400 mb-3 uppercase tracking-wide">
                  {category}
                </h3>
